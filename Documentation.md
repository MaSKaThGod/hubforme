# Maska Library
This documentation is for the stable release of Maska Library.
...
## Creating a Window
```lua
local Window = MaskaLib:MakeWindow({Name = "Title of the library", HidePremium = false, SaveConfig = true, ConfigFolder = "MaskaTest"})
...
print(MaskaLib.Flags["toggle"].Value) -- prints the value of the toggle.
```
